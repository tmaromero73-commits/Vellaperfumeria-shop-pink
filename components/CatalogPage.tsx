...
// URL del Catálogo 2026 actualizada
const INTERACTIVE_CATALOG_URL = 'https://es-catalogue.oriflame.com/oriflame/es/2026001?HideStandardUI=true&Page=1';
        ...
        <div className="w-full px-2 sm:px-4 py-6 bg-gray-50">
                ...
                <div className="flex-grow flex flex-col min-w-0">
                    <div className="mb-4 flex items-center gap-4 flex-wrap md:flex-nowrap justify-center md:justify-start">
                        ...
                        <div className="text-center md:text-left">
                            <h1 className="text-3xl md:text-4xl font-extrabold text-black tracking-tight font-serif">Catálogo Oficial 2026</h1>
                            <p className="text-sm text-gray-600 mt-1">
                                Explora las tendencias de la nueva temporada 2026 y descubre ofertas exclusivas.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <iframe
                            ...
                            title="Catálogo Digital Vellaperfumeria 2026"
                ...
                <div className="w-full md:w-80 lg:w-96 flex-shrink-0 space-y-6">
                    <div className="bg-white p-6 rounded-lg shadow-xl border border-gray-100 sticky top-24">
                        ...
                        <div className="bg-fuchsia-50 p-4 rounded-md mb-6 border border-fuchsia-100">
                            <p className="text-sm font-bold text-gray-800 mb-2">¿Cómo comprar del catálogo?</p>
                            <ol className="list-decimal list-inside text-sm text-gray-700 space-y-2">
                                <li>Busca el <strong>Código</strong> del producto en el catálogo 2026.</li>
                                <li>Ingresa el código aquí debajo.</li>
                                <li>¡Añádelo instantáneamente a tu cesta!</li>
                            </ol>
                        </div>
                        ...
                        <form onSubmit={handleQuickAdd} className="space-y-3">
                            ...
                            <button
                                ...
                                className="w-full bg-black text-white font-bold py-3 px-4 rounded-md hover:bg-fuchsia-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed shadow-lg"
                            >
                                Añadir a la cesta
                            </button>
                        </form>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100">
                            <p className="text-xs font-semibold text-gray-500 text-center mb-3 uppercase tracking-wider">Pagos 100% seguros:</p>
            ...
            <div className="mt-12 border-t border-gray-200 pt-12">
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-extrabold text-black tracking-tight">Novedades Destacadas 2026</h2>
                    <p className="mt-2 text-lg text-gray-600">Compra directamente tus favoritos del nuevo catálogo</p>
                </div>
